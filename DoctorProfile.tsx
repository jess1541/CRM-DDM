  ...
  return (
    <div className="space-y-6 pb-16 animate-fadeIn">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center gap-6 bg-white p-6 md:p-8 rounded-[2.5rem] shadow-xl border border-slate-200 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-red-500/5 to-orange-500/5 rounded-full blur-3xl -z-10 opacity-60"></div>
          
          <div className="flex flex-col md:flex-row items-center gap-5 md:gap-8 text-center md:text-left z-10">
            <div className="p-5 bg-gradient-to-br from-red-600 to-red-700 rounded-[1.5rem] text-white shadow-xl shadow-red-500/20 ring-4 ring-white/50">
                <Zap className="w-8 h-8" />
            </div>
            <div>
                <h1 className="text-3xl md:text-4xl font-black text-slate-900 tracking-tighter leading-tight">
                    Dashboard <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-red-400">Estratégico</span>
                </h1>
          ...
          <div className="flex flex-wrap items-center gap-3 w-full md:w-auto justify-center z-10">
            <div className={`px-5 py-2.5 rounded-2xl flex items-center gap-2.5 border font-black text-[10px] uppercase tracking-widest shadow-sm ${isOnline ? 'bg-red-50 text-red-600 border-red-100' : 'bg-rose-50 text-rose-600 border-rose-100'}`}>
                <div className={`w-2 h-2 rounded-full ${isOnline ? 'bg-red-500 animate-pulse shadow-[0_0_8px_rgba(16,185,129,0.2)]' : 'bg-rose-500'}`}></div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        {/* Card 1: Cartera */}
        <div className="bg-red-50 p-6 md:p-8 rounded-[2.5rem] shadow-md border border-red-100 relative overflow-hidden group hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
          <div className="absolute -right-6 -bottom-6 w-32 h-32 bg-red-100/50 rounded-full group-hover:scale-110 transition-transform duration-500"></div>
          <Users className="absolute -right-4 -bottom-4 w-24 h-24 text-red-200/20 group-hover:text-red-500/10 transition-colors duration-300" />
          
          <div className="relative z-10">
              <div className="w-10 h-10 rounded-2xl bg-white flex items-center justify-center mb-4 shadow-sm group-hover:bg-red-100 transition-colors">
                  <Users className="w-5 h-5 text-red-500" />
              </div>
              <p className="text-[10px] font-black text-red-600/60 uppercase tracking-widest mb-1">Cartera Total</p>
              <div className="flex items-baseline gap-2">
                  <span className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight">{stats.totalDoctors}</span>
                  <span className="text-[10px] font-bold text-red-400 uppercase">Contactos</span>
              </div>
          </div>
        </div>

        {/* Card 2: Efectividad */}
        <div className="bg-gradient-to-br from-red-600 to-red-700 p-6 md:p-8 rounded-[2.5rem] shadow-xl shadow-red-500/20 text-white relative overflow-hidden group hover:-translate-y-1 transition-transform duration-300 border border-white/10">
          ...
          <div className="relative z-10">
              ...
              <p className="text-[10px] font-black text-red-100 uppercase tracking-widest mb-1">Efectividad {currentMonthName}</p>
        ...
        <div className="bg-red-50 p-6 md:p-8 rounded-[2.5rem] shadow-md border border-red-100 relative overflow-hidden group hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="relative z-10">
              ...
              <p className="text-[10px] font-black text-red-600/60 uppercase tracking-widest mb-1">Ventas del Mes</p>
              ...
              <div className="mt-3 inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-red-100 text-red-700 border border-red-200">
      ...
      <div className="bg-white p-6 md:p-8 rounded-[2rem] md:rounded-[3rem] shadow-lg border border-slate-200 relative overflow-hidden">
          ...
          <div className="relative z-10">
              <h3 className="text-lg md:text-xl font-black text-slate-900 uppercase tracking-tight mb-6 flex items-center gap-3">
                  <Download className="w-6 h-6 text-red-600" /> Centro de Reportes
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  >
                      <div className="flex items-center gap-4">
                          <div className="p-3 bg-red-600 rounded-xl text-white shadow-lg group-hover:scale-110 transition-transform"><Users className="w-6 h-6" /></div>
                  ...
                  >
                      <div className="flex items-center gap-4">
                          <div className="p-3 bg-rose-600 rounded-xl text-white shadow-lg group-hover:scale-110 transition-transform"><Activity className="w-6 h-6" /></div>
                          <div className="text-left">
          ...
          <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white p-8 rounded-[3rem] shadow-lg border border-slate-200">
                  <div className="flex justify-between items-center mb-8">
                      <h3 className="text-xl font-black text-slate-900 uppercase tracking-tight flex items-center gap-3">
                          <BarChart3 className="w-6 h-6 text-red-600" /> Pipeline de Conversión
                      </h3>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      {Object.entries(stats.outcomes).map(([key, value]) => (
                          <div 
                            ...
                            className="bg-slate-50 p-6 rounded-[2rem] border border-slate-100 hover:border-red-500/30 hover:bg-red-50 transition-all cursor-pointer group"
                          >
                              <div className="flex justify-between items-center mb-2">
                                <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest group-hover:text-red-600">{key}</p>
                                <ChevronRight className="w-4 h-4 text-slate-300 group-hover:text-red-600 opacity-0 group-hover:opacity-100 transition-all" />
                              </div>
                              <div className="flex justify-between items-end">
                                  <span className="text-3xl font-black text-slate-900 group-hover:text-red-600">{value}</span>
              ...
              <div className="bg-white p-8 rounded-[3rem] shadow-lg border border-slate-200 relative overflow-hidden">
                  ...
                  <h3 className="text-xl font-black text-slate-900 uppercase tracking-tight mb-8 relative z-10 flex items-center gap-3">
                      <PieChart className="w-6 h-6 text-rose-600" /> Análisis de Clasificación
                  </h3>
                  
                  <div className="space-y-6 relative z-10">
                      {[
                        { label: 'Top Productivo (A)', count: stats.classifications.A, color: 'bg-red-500' },
                        { label: 'Potencial Alto (B)', count: stats.classifications.B, color: 'bg-red-500' },
          ...
          <div className="space-y-8">
              ...
              <div className="bg-white p-8 rounded-[3rem] shadow-lg border border-slate-200 h-full">
                  <h3 className="text-lg font-black text-slate-900 uppercase tracking-tight mb-6 flex items-center gap-3">
                      <Calendar className="w-5 h-5 text-red-600" /> Próxima Agenda
                  </h3>
                  ...
                  <div className="space-y-4">
                      {stats.upcomingVisits.length > 0 ? stats.upcomingVisits.map((visit, idx) => (
                          <div 
                            ...
                            className="p-4 bg-slate-50 rounded-2xl border border-transparent hover:border-red-500/30 cursor-pointer transition-all group"
                          >
                              <div className="flex justify-between items-start mb-2">
                                  <span className="text-[9px] font-black bg-white px-2 py-1 rounded-lg text-red-600 shadow-sm border border-slate-100 uppercase">{visit.date}</span>
                                  <div className="flex gap-1">
                                      {visit.priority === 'ALTA' && <div className="w-2 h-2 rounded-full bg-rose-500"></div>}
                                      <Clock className="w-3 h-3 text-slate-300" />
                                  </div>
                              </div>
                              <p className="text-xs font-black text-slate-800 uppercase truncate group-hover:text-red-600">{visit.docName}</p>
                      ...
                      <button 
                        ...
                        className="w-full py-4 mt-2 border-2 border-dashed border-slate-200 rounded-2xl text-[10px] font-black text-slate-400 uppercase tracking-widest hover:border-red-500/40 hover:text-red-600 transition-all"
                      >
      ...
      <div className="bg-white p-8 rounded-[3rem] shadow-lg border border-slate-200">
          <div className="flex justify-between items-center mb-8">
              <h3 className="text-xl font-black text-slate-900 uppercase tracking-tight flex items-center gap-3">
                  <Activity className="w-6 h-6 text-red-600" /> Actividad Reciente
              </h3>
              <div className="flex gap-2">
                  <div className="px-3 py-1 bg-red-50 text-red-600 rounded-full text-[9px] font-black uppercase tracking-widest">Feed Directo</div>
              </div>
          </div>
                          ...
                          <tr key={i} className="group hover:bg-slate-50 transition-colors">
                              ...
                              <td className="py-5">
                                  <div className="flex items-center gap-3">
                                      <div className="w-8 h-8 rounded-xl bg-red-50 text-red-600 flex items-center justify-center font-black text-[10px]">{act.docName.charAt(0)}</div>
                              ...
                              <td className="py-5">
                                  <span className={`px-2 py-0.5 rounded text-[9px] font-black uppercase border ${
                                      act.classification === 'A' ? 'bg-red-50 text-red-600 border-red-100' :
                                      act.classification === 'B' ? 'bg-red-50 text-red-600 border-red-100' :
                              ...
                              <td className="py-5">
                                  <span className={`px-3 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest border ${
                                      act.outcome === 'INTERESADO' ? 'bg-red-50 text-red-600 border-red-100' :
                                      act.outcome === 'COTIZACIÓN' ? 'bg-red-50 text-red-600 border-red-100' :
                                      'bg-slate-50 text-slate-400 border-slate-100'
                                  }`}>{act.outcome}</span>
                              </td>
                              ...
                              <td className="py-5 text-right">
                                  <button onClick={() => navigate(`/doctors/${act.docId}`)} className="p-2 text-slate-300 hover:text-red-600 transition-colors">
      ...
      <div className="bg-white p-8 rounded-[3rem] shadow-lg border border-slate-200">
          <div className="flex justify-between items-center mb-8">
              <h3 className="text-xl font-black text-slate-900 uppercase tracking-tight flex items-center gap-3">
                  <Stethoscope className="w-6 h-6 text-rose-600" /> Procedimientos Recientes
              </h3>
              <div className="flex gap-2">
                  <div className="px-3 py-1 bg-rose-50 text-rose-600 rounded-full text-[9px] font-black uppercase tracking-widest">Últimos Registros</div>
              </div>
          </div>
                  ...
                  <tbody className="divide-y divide-slate-50">
                      {stats.recentProcedures.map((proc, i) => (
                          <tr key={i} className="group hover:bg-slate-50 transition-colors">
                              ...
                              <td className="py-5">
                                  <div className="flex items-center gap-3">
                                      <div className="w-8 h-8 rounded-xl bg-rose-50 text-rose-600 flex items-center justify-center font-black text-[10px]">{proc.doctorName.charAt(0)}</div>
                              ...
                              <td className="py-5">
                                  <span className={`px-2 py-0.5 rounded text-[9px] font-black uppercase border ${
                                      proc.paymentType === 'DIRECTO' ? 'bg-red-50 text-red-600 border-red-100' :
                              ...
                              <td className="py-5">
                                  <span className={`px-3 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest border ${
                                      proc.status === 'performed' ? 'bg-red-50 text-red-600 border-red-100' :
                              ...
                              <td className="py-5 text-right">
                                  <button onClick={() => navigate(`/procedures`)} className="p-2 text-slate-300 hover:text-rose-600 transition-colors">
                                      <ChevronRight className="w-5 h-5" />
                                  </button>
                              </td>
                          </tr>
                ...
                <div className="p-6 md:p-8 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                    <div>
                        <h3 className="text-xl md:text-2xl font-black text-slate-900 uppercase tracking-tight flex items-center gap-3">
                            <BarChart3 className="w-5 h-5 md:w-6 md:h-6 text-red-600" />
                            Detalle: <span className="text-red-600">{selectedStage}</span>
                        </h3>
                            ...
                            <tbody className="divide-y divide-slate-50">
                                {stageDetails.map((item, idx) => (
                                    <tr key={idx} className="group hover:bg-slate-50 transition-colors">
                                        ...
                                        <td className="py-4">
                                            <div className="flex items-center gap-3">
                                                <div className="w-8 h-8 rounded-xl bg-red-50 text-red-600 flex items-center justify-center font-black text-[10px]">{item.doctor.charAt(0)}</div>
                                                <span className="text-xs font-black text-slate-800 uppercase group-hover:text-red-600">{item.doctor}</span>
                                            </div>
                                        </td>
                                        <td className="py-4 text-xs font-medium text-slate-500 uppercase">{item.specialty || '-'}</td>
                                        <td className="py-4">
                                            <span className={`px-2 py-0.5 rounded text-[9px] font-black uppercase border ${
                                                item.classification === 'A' ? 'bg-red-50 text-red-600 border-red-100' :
                                                item.classification === 'B' ? 'bg-red-50 text-red-600 border-red-100' :
                                        ...
                                        <td className="py-4 text-right">
                                            <button onClick={() => navigate(`/doctors/${item.docId}`)} className="p-2 text-slate-300 hover:text-red-600 transition-colors">
