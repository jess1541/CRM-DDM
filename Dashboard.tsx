          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div>
                  ...
                  <DatePicker 
                      ...
                      locale="es"
                      className="w-full border border-slate-200 bg-slate-50 rounded-xl p-3 text-sm font-bold text-slate-900 focus:ring-2 focus:ring-red-500 outline-none uppercase"
                  />
              </div>
              <div>
                  ...
                  <div className="relative">
                      <select
                          className="w-full border border-slate-200 bg-slate-50 rounded-xl p-3 text-sm font-bold text-slate-900 focus:ring-2 focus:ring-red-500 outline-none uppercase appearance-none"
              ...
              <div className="flex items-end">
                  {visitsWithLocation.length > 1 ? (
                      <a 
                          ...
                          className="w-full flex items-center justify-center px-6 py-3 bg-red-600 text-white rounded-xl font-black text-xs uppercase tracking-widest hover:bg-red-700 transition shadow-lg shadow-red-500/30"
                      >
              ...
              visitsWithLocation.map((item, index) => (
                  <div key={`${item.visit.id}-${index}`} className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 hover:shadow-md transition-all">
                      <div className="flex items-start gap-4">
                          <div className="w-10 h-10 rounded-full bg-red-50 text-red-600 flex items-center justify-center font-black text-sm border border-red-100 shrink-0">
                              {index + 1}
                          </div>
                          <div>
                      ...
                      <div className="flex flex-col items-end gap-2 w-full md:w-auto">
                          ...
                          <div className="flex items-center gap-2">
                            <a 
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-xs font-bold text-red-500 hover:text-red-700 flex items-center uppercase tracking-wide"
                            >
