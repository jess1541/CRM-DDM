    ...
    <div className="space-y-6 pb-16 animate-fadeIn">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center gap-6 bg-white p-6 md:p-8 rounded-[2rem] md:rounded-[3rem] shadow-xl border border-slate-100">
          ...
          <button 
            ...
            className="px-6 py-3 bg-red-600 hover:bg-red-700 text-white rounded-2xl font-bold text-xs uppercase tracking-widest shadow-lg shadow-red-200 transition-all flex items-center gap-2"
          >
                ...
                <tr key={(u as any).id || u.name} className="group hover:bg-slate-50/50 transition-colors">
                  <td className="py-5">
                    <div className="flex items-center gap-3">
                      <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-black text-xs ${u.role === 'admin' ? 'bg-yellow-100 text-yellow-600' : 'bg-red-100 text-red-600'}`}>
                  ...
                  <td className="py-5">
                    <span className={`px-3 py-1 rounded-lg text-[10px] font-black uppercase tracking-widest border ${
                      u.role === 'admin' ? 'bg-yellow-50 text-yellow-600 border-yellow-100' : 'bg-red-50 text-red-600 border-red-100'
                    }`}>
        ...
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-md overflow-hidden animate-fadeIn border border-white/20">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-10 border border-slate-200 rounded-xl p-3 text-sm font-bold focus:ring-2 focus:ring-red-500 outline-none transition-all shadow-sm placeholder-slate-300 text-slate-900 bg-white"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select 
                    ...
                    className="w-full pl-10 border border-slate-200 rounded-xl p-3 text-sm font-bold focus:ring-2 focus:ring-red-500 outline-none transition-all shadow-sm text-slate-900 bg-white appearance-none"
                  >
            ...
            <div className="p-6 border-t border-slate-100 bg-slate-50 flex justify-end gap-3">
              ...
              <button onClick={handleSave} className="px-6 py-2.5 bg-red-600 hover:bg-red-700 text-white font-bold rounded-xl shadow-lg shadow-red-500/30 transition-all active:scale-95 text-sm flex items-center">
